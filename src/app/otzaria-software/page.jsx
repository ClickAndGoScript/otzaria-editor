...
export default function OtzariaSoftwarePage() {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Link href="/otzaria-software/about" className="flex items-center justify-center gap-2 px-8 py-4 glass border-2 border-primary text-primary rounded-lg text-lg font-medium hover:bg-primary-container transition-colors">
