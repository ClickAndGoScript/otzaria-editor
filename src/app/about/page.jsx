            ...
            >
              ...
              <div className="glass p-8 rounded-xl">
                ...
                <p className="text-lg text-on-surface/80 leading-relaxed mb-6">
                  לצורך עדכון והרחבת מאגר ספריית אוצריא עובדים מתנדבים רבים מכל העולם. 
                  הצטרפו אליהם והיו שותפים בשימור והנגשת המורשת התורנית!
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link 
                    href="/users" 
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-primary text-on-primary rounded-lg hover:bg-accent transition-colors"
                  >
                  ...
                  <Link 
                    href="/upload" 
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-surface text-on-surface rounded-lg hover:bg-surface-variant transition-colors border border-outline"
                  >
              ...
              <div className="text-center pt-8">
                ...
                <Link 
                  href="/library" 
                  className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-on-primary rounded-lg text-lg font-medium hover:bg-accent transition-colors shadow-lg hover:shadow-xl"
                >
